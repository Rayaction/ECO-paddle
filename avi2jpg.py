...
target_train_dir = 'data/data48916UCF-101/train_split01'
target_test_dir = 'data/data48916/UCF-101/test_split01'
target_val_dir = 'data/data48916/UCF-101/val_split01'
    ...
    for each_label_mulu in label_mulu:
        ...
        if vid in label_washed:
            for i in range(image_num):
                image_path = os.path.join(os.path.join(label_dir, each_label_mulu),
